...
func UpdateAssetsSubpath(subpath string) error {
	...
	reCSP := regexp.MustCompile(`<meta http-equiv="Content-Security-Policy" content="script-src 'self' 'unsafe-eval' cdn.segment.com/analytics.js/([^"]*)">`)
	...
	newRootHtml = reCSP.ReplaceAllLiteralString(newRootHtml, fmt.Sprintf(
		`<meta http-equiv="Content-Security-Policy" content="script-src 'self' 'unsafe-eval' cdn.segment.com/analytics.js/ 'sha256-%s'">`,
